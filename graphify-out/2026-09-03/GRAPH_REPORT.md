...
## Corpus Check
- 417 files · ~221,976 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2172 nodes · 5236 edges · 220 communities (115 shown, 105 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 15 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `04a5d58c`
...
Cohesion: 0.06
Nodes (48): appearanceLocation(), MediaAppearancesSection(), splitLocationLabel(), SelectedPerson, currencies, BusyAction, Editor, STEPS (+40 more)

### Community 2 - "cn()"
Cohesion: 0.15
Nodes (20): AboutPage(), DISCIPLINE_HREFS, generateMetadata(), DancingPage(), generateMetadata(), generateMetadata(), generateMetadata(), PeoplePage() (+12 more)
...
Cohesion: 0.13
Nodes (26): AdminBlogCategoriesPage(), buildAccessRateLimitKey(), POST(), GET(), PrivateGalleryPage(), client, createPrivateGalleryCookieValue(), getPrivateGalleryCookieSecret() (+18 more)
...
Cohesion: 0.14
Nodes (29): PATCH(), SLUG_TO_PATH, asDate(), GET(), POST(), asNullableString(), asNumberOrNull(), isRecord() (+21 more)

### Community 7 - "getDb()"
Cohesion: 0.15
Nodes (40): DELETE(), PATCH(), GET(), asDate(), DELETE(), PATCH(), ALLOWED, decrementServiceInquiriesCount() (+32 more)
...
Cohesion: 0.13
Nodes (20): CardImageWarning(), CardsCtaForm(), CtaFields(), CtaOnlyForm(), DancingSectionsForm(), HomeSectionsForm(), SLUG_LABELS, AnySections (+12 more)
...
Cohesion: 0.17
Nodes (17): ServiceDetailPage(), HomeServicesPreview(), serviceDirections, ServiceCard(), Discipline, DISCIPLINE_HREF, disciplineForCategory(), DisciplineSlug (+9 more)
...
Cohesion: 0.13
Nodes (25): AdminServiceCategoriesPage(), AdminServicesClient(), ServiceEditorModal(), ServicesBanner(), ServiceSimpleSection(), archiveService(), createService(), deleteServiceForever() (+17 more)
...
Cohesion: 0.16
Nodes (21): MediaDetailsSection(), AdminServiceCategoriesClient(), CategoriesTable(), CategoriesToolbar(), CategoryFormCard(), CategoryRow(), createCategoryRequest(), deleteCategoryRequest() (+13 more)

### Community 17 - "db.ts"
Cohesion: 0.10
Nodes (43): asBooleanOrNull(), asFiniteLatitude(), asFiniteLongitude(), getMediaLists(), MediaLocation, NftCurrency, NftEditionType, NftStatus (+35 more)
...
Cohesion: 0.07
Nodes (26): After L11 — the release gate and deploy, Block A — launch blockers, Block B — before the domain goes public, Block C — hardening; may trail launch by a few days, Completed so far — full specs + outcomes in SESSION-ARCHIVE.md, Final — runs after every other Phase L session, Gaps awaiting a decision from Hussain, HM Visuals — Session Queue (+18 more)
...
Cohesion: 0.14
Nodes (22): NftPage(), PersonDetailPage(), generateMetadata(), VideographyPage(), TagDiscipline, getPageSections(), mergeWithDefaults(), disciplineMatch() (+14 more)

### Community 30 - "page-sections.ts"
Cohesion: 0.12
Nodes (17): BlogCategoriesAdminClient(), Category, CategoryRow(), useMediaEditorController(), AdminMediaPage(), RemovalRequestsClient(), ServicesToolbar(), TagsToolbar() (+9 more)
...
Cohesion: 0.06
Nodes (49): NftMeta, buildCursorCondition(), buildQuery(), Cursor, escapeRegExp(), GET(), makeCursor(), parseCursor() (+41 more)

### Community 38 - "Glossary"
Cohesion: 0.08
Nodes (25): generateMetadata(), generateMetadata(), AboutDisciplineCard(), HeroBokeh(), makeBokehTexture(), DISCIPLINE_LINKS, HomeCreativeSystem(), CTA_LABELS (+17 more)

### Community 39 - "AdminServicesClient.tsx"
Cohesion: 0.10
Nodes (19): HM Visuals — Session Archive, Phase 2 — Dancing page, Phase 2 — People page, Phase 2 — Preloader & core experience, Phase 2a — Design direction (ran before D4), Phase 3 — Content & analytics, Phase L — Launch readiness, Phase S — Security & hardening (+11 more)
...
Cohesion: 0.20
Nodes (11): ExhibitionCityIndex(), ExhibitionCityModal(), ExhibitionGlobe, HomeExhibitionGlobe(), downloadCloudinaryFile(), toCloudinaryAttachmentUrl(), useModalNavbarLock(), PrivateGalleryBrowser() (+3 more)
...
Cohesion: 0.19
Nodes (18): POST(), getClientAddress(), HeaderGetter, isValidEmail(), isValidFormStartedAt(), POST(), POST(), GET() (+10 more)
...
Cohesion: 0.21
Nodes (10): CardImageGroup(), GroupCard(), GroupTint, ICON_TINTS, TINTS, SectionsData, SeoDraft, SeoPageForm() (+2 more)
...
Cohesion: 0.14
Nodes (20): ContactPage(), generateMetadata(), SP, HomePage(), generateMetadata(), PhotographyPage(), generateMetadata(), ServicesPage() (+12 more)

### Community 54 - "public-media.ts"
Cohesion: 0.31
Nodes (10): PAGE_ROWS, AdminPagesPage(), AdminPageEditor(), PageEditorClient(), PATCH(), SLUG_TO_PATH, isAdminAuthedServer(), getAllPageSections() (+2 more)

### Community 55 - "components/site/AppShell.tsx"
Cohesion: 0.32
Nodes (9): GET(), ALWAYS_ON_PRIMARY, PRIMARY_DISCIPLINE_SLUGS, SiteFooter(), DISCIPLINES, defaultPageSettings(), getAllPageSettings(), getPageSettings() (+1 more)
...
Cohesion: 0.16
Nodes (15): AdminProtectedLayout(), AdminMobileNav(), AdminSidebarNav(), AdminThemeToggle(), useIsMounted(), NAV_GROUPS, NavGroup, NavItem (+7 more)

### Community 61 - "page.tsx"
Cohesion: 0.15
Nodes (10): PrivateGalleriesAdminClient(), BulkAction, BulkActionBar(), GalleryFormFields(), GalleryFormFieldsProps, Admin, GalleryWizard(), STEPS (+2 more)
...
Cohesion: 0.13
Nodes (13): AppearanceBlock(), MediaSurface(), MediaItem, TagLink, localFilterItems(), PublicMediaResponse, PublicMediaSearchMode, useMediaSearch() (+5 more)
...
Cohesion: 0.38
Nodes (7): PATCH(), VALID_SLUGS, collectSectionImagePublicIds(), EMPTY_SECTION_IMAGE, isSectionImage(), resolveOptionalCardImage(), deleteReplacedSectionImages()

### Community 101 - "download.ts"
Cohesion: 0.23
Nodes (12): TagMultiSelect(), TagOption, POST(), asString(), GET(), POST(), serializeTag(), tagCounts() (+4 more)

### Community 102 - "ModalPortal.tsx"
Cohesion: 0.24
Nodes (11): isAllowedCloudinaryTestimonialUrl(), NormalizedResolvedLocation, normalizeOptionalPhotoUrl(), normalizeRating(), normalizeResolvedLocation(), POST(), resend, sendInquiryNotification() (+3 more)
...
Cohesion: 0.21
Nodes (9): MediaAssetSection(), AdminButtonProps, AdminButtonSize, AdminButtonVariant, BaseProps, SIZE, VARIANT, CloudinaryUploadButton() (+1 more)
...
### Community 108 - "Button.tsx"
Cohesion: 0.23
Nodes (8): BaseProps, Button(), buttonClasses(), ButtonProps, ButtonVariant, VARIANT, PortfolioCard(), PortfolioCardProps

### Community 109 - "InquirySection.tsx"
Cohesion: 0.33
Nodes (7): IconButton(), ArchiveIcon(), DeleteIcon(), RestoreIcon(), InquirySection(), fmt(), statusPill()

### Community 110 - "cloudinary-folders.ts"
Cohesion: 0.32
Nodes (7): MediaWizard(), CLOUDINARY_MEDIA_CATEGORY_FOLDER_MAP, CLOUDINARY_MEDIA_CATEGORY_FOLDERS, CloudinaryMediaCategory, getCloudinaryMediaFolderForCategory(), getCloudinaryMediaFoldersForCategories(), isCloudinaryMediaCategory()
...
### Community 114 - "Phase S2 — Defects from the 2026-08-17 full-repo audit"
Cohesion: 0.67
...
Cohesion: 0.12
Nodes (19): AdminDashboard(), CATEGORY_ICONS, PageEditorBody(), pageGroup, pageNeedsImage(), PageRow, GROUPS, PagesAdminClient() (+11 more)
...
- **Why does `getDb()` connect `getDb()` to `cloudinary-assets.ts`, `TransitionContext.tsx`, `apple-design skill`, `tag-pages.ts`, `PagesAdminClient.tsx`, `getPageSeo()`, `Animation Recipes`, `db.ts`, `Animation Standards Reference`, `ContactForm.tsx`, `PeopleAdminClient.tsx`, `PublicReviewForm.tsx`, `Apple Design`, `media-picker-utils.ts`, `Glossary`, `page.tsx`, `Page Content CMS (3 collections)`, `Finding Animation Opportunities`, `SmartMediaPreview.tsx`, `public-media.ts`, `components/site/AppShell.tsx`, `The list`, `SmartMediaPreview.tsx`, `package.json`, `ExhibitionGlobe.tsx`, `route.ts`, `download.ts`, `ModalPortal.tsx`?**
