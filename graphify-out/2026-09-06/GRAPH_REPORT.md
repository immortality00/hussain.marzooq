# Graph Report - hussain.marzooq  (2026-09-06)

## Corpus Check
- 439 files · ~234,332 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2275 nodes · 5584 edges · 222 communities (115 shown, 107 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 17 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d1217d0`
...
1. `getDb()` - 171 edges
2. `noStoreJson()` - 98 edges
3. `adminButtonClasses()` - 88 edges
4. `isRecord()` - 64 edges
5. `getPageSeo()` - 50 edges
6. `requireAdminObjectId()` - 41 edges
7. `HM Visuals — Claude Working Document` - 41 edges
8. `findByIdOr404()` - 38 edges
9. `buildPublicMetadata()` - 37 edges
10. `requireAdminOr401()` - 36 edges
...
## Communities (222 total, 107 thin omitted)

### Community 0 - "admin.ts"
Cohesion: 0.17
Nodes (24): POST(), asNullableString(), getClientAddress(), HeaderGetter, isValidEmail(), POST(), POST(), buildAccessRateLimitKey() (+16 more)

### Community 1 - "getDb()"
Cohesion: 0.16
Nodes (32): DELETE(), asDate(), DELETE(), PATCH(), ALLOWED, decrementServiceInquiriesCount(), DELETE(), hasValidServiceId() (+24 more)

### Community 2 - "GalleryWizard.tsx"
Cohesion: 0.24
Nodes (12): MediaPickerModal(), buildMediaQuery(), MediaListResponse, mediaMetaText(), mergeMediaItems(), PrivateGalleryMediaCard(), PrivateGalleryMediaCardProps, PrivateGalleryMediaPicker() (+4 more)

### Community 3 - "route.ts"
Cohesion: 0.17
Nodes (29): asFiniteLatitude(), asFiniteLongitude(), getMediaLists(), parseMediaLocation(), resolvePeopleSelection(), sanitizeAppearances(), MEDIA_BASE_PATHS, revalidateMediaSurfaces() (+21 more)

### Community 4 - "TransitionContext.tsx"
Cohesion: 0.06
Nodes (38): metadata, RootLayout(), SiteAnalytics(), AppShell(), CustomCursor(), stepSpring(), stretchFor(), Navbar() (+30 more)

### Community 5 - "isRecord()"
Cohesion: 0.14
Nodes (24): AdminBlogCategoriesPage(), GET(), POST(), GET(), GET(), asString(), isValidObjectIdString(), parseObjectId() (+16 more)

### Community 6 - "route.ts"
Cohesion: 0.35
Nodes (15): asStringArray(), PATCH(), POST(), hashGalleryPassword(), isFutureDate(), makeGalleryAccessToken(), makeGallerySlug(), normalizeLocalDateTimeString() (+7 more)

### Community 7 - "adminButtonClasses()"
Cohesion: 0.09
Nodes (35): InquiriesToolbar(), AdminMediaBatchPage(), MediaAssetSection(), useMediaEditorController(), MediaListFilterBar(), Props, formatNftQuantity(), MediaItem (+27 more)

### Community 8 - "getPageSections()"
Cohesion: 0.12
Nodes (27): DancingPage(), NftPage(), PeoplePage(), PersonDetailPage(), PhotographyPage(), PhotographyTagPage(), renderStars(), TestimonialsPage() (+19 more)

### Community 9 - "testimonial-upload-sessions.ts"
Cohesion: 0.07
Nodes (49): isValidFormStartedAt(), isAllowedCloudinaryTestimonialUrl(), NormalizedResolvedLocation, normalizeOptionalPhotoUrl(), normalizeRating(), normalizeResolvedLocation(), POST(), ALLOWED_SIGN_KEYS (+41 more)

### Community 10 - "AdminServicesClient.tsx"
Cohesion: 0.16
Nodes (25): hasGalleryAccess(), openUnlockedGallery(), UnlockedGallery, generateMetadata(), PrivateGalleryPage(), createPrivateGalleryCookieValue(), getPrivateGalleryCookieSecret(), getPrivateGalleryExpiryDate() (+17 more)

### Community 11 - "page-sections.ts"
Cohesion: 0.09
Nodes (31): CardImageWarning(), CardsCtaForm(), CtaFields(), CtaOnlyForm(), DancingSectionsForm(), HomeSectionsForm(), SLUG_LABELS, AnySections (+23 more)
...
Cohesion: 0.10
Nodes (19): HeroBokeh(), makeBokehTexture(), DISCIPLINE_LINKS, HomeCreativeSystem(), CTA_LABELS, HomeFeaturedWork(), DISCIPLINE_ORDER, HomeHero() (+11 more)

### Community 15 - "page.tsx"
Cohesion: 0.06
Nodes (51): NftMeta, buildCursorCondition(), buildQuery(), Cursor, escapeRegExp(), GET(), makeCursor(), parseCursor() (+43 more)
...
Cohesion: 0.14
Nodes (23): BlogPage(), BlogPostPage(), ALWAYS_PUBLIC, entry(), sitemap(), withSlug(), BlogCard(), formatBlogDate() (+15 more)
...
Cohesion: 0.21
Nodes (13): InquiryExpandedCard(), archiveInquiry(), deleteInquiryForever(), fetchInquiries(), isApiResponse(), patchInquiry(), restoreInquiry(), ApiInquiriesResponse (+5 more)
...
Cohesion: 0.11
Nodes (32): GET(), HomePage(), ServicesPage(), generateMetadata(), getPublicService(), PublicService, ServiceDetailPage(), HomeServicesPreview() (+24 more)

### Community 30 - "types.ts"
Cohesion: 0.16
Nodes (12): ExhibitionCityIndex(), ExhibitionCityModal(), ExhibitionGlobe, HomeExhibitionGlobe(), MediaSurface(), MediaItem, TagLink, useModalNavbarLock() (+4 more)

### Community 31 - "page-settings.ts"
Cohesion: 0.10
Nodes (33): AdminDashboard(), CATEGORY_ICONS, PAGE_ROWS, pageGroup, pageNeedsImage(), PageRow, AdminPagesPage(), GROUPS (+25 more)
...
Cohesion: 0.17
Nodes (24): GET(), parseWidth(), GET(), POST(), findGalleryMedia(), listGalleryMedia(), CloudinaryAssetResourceType, CloudinaryDeliveryType (+16 more)

### Community 34 - "components/shared/Button.tsx"
Cohesion: 0.05
Nodes (38): About page — rebuilt (D2c, shipped 2026-08-18), Admin design, Analytics — shipped (C3, 2026-08-30), Animation stack status, Blog (C1, shipped 2026-08-29), Claude tooling for this project, Code quality rules, Commit message format (+30 more)
...
Cohesion: 0.18
Nodes (11): MediaLocation, NftCurrency, NftEditionType, NftStatus, normalizeCurrency(), normalizeEditionType(), normalizeStatus(), parseFutureDateTimeString() (+3 more)

### Community 38 - "route.ts"
Cohesion: 0.14
Nodes (19): asNumberOrNull(), GET(), POST(), CleanupResult, cleanupTestimonialCloudinary(), collectTestimonialAssetUrls(), DELETE(), deleteAssetsByPublicIds() (+11 more)
...
Cohesion: 0.09
Nodes (23): PeopleAdminClient(), statusLabel(), VISIBILITY_OPTIONS, PrivateGalleriesAdminClient(), AdminTagsClient(), runBulkAction(), useBulkSelection(), GalleryFormFields() (+15 more)

### Community 48 - "Empty means empty — no auto-pick"
Cohesion: 0.08
Nodes (23): After L11 — the release gate and deploy, Block A — launch blockers, Block B — before the domain goes public, Block C — hardening; may trail launch by a few days, Completed so far — full specs + outcomes in SESSION-ARCHIVE.md, Final — runs after every other Phase L session, Gaps awaiting a decision from Hussain, HM Visuals — Session Queue (+15 more)
...
Cohesion: 0.10
Nodes (20): Build outcome, HM Visuals — Session Archive, §L7 — Private galleries: authenticated delivery + expiring downloads — `done` (2026-09-04), Phase 2 — Dancing page, Phase 2 — People page, Phase 2 — Preloader & core experience, Phase 3 — Content & analytics, Phase L — Launch readiness (+12 more)
...
### Community 53 - "public-people.ts"
Cohesion: 0.10
Nodes (32): AboutPage(), DISCIPLINE_HREFS, generateMetadata(), generateMetadata(), generateMetadata(), ContactPage(), generateMetadata(), SP (+24 more)
...
### Community 55 - "db.ts"
Cohesion: 0.13
Nodes (25): AdminServiceCategoriesPage(), AdminServicesClient(), ServiceEditorModal(), ServiceSimpleSection(), archiveService(), createService(), deleteServiceForever(), getError() (+17 more)

### Community 56 - "BatchMediaClient.tsx"
Cohesion: 0.17
Nodes (10): BATCH_CATEGORY_OPTIONS, BatchMediaClient(), STEPS, BatchFile, useBatchMediaState(), TagMultiSelect(), TagOption, CloudinaryMultiUploadButton() (+2 more)
...
Cohesion: 0.20
Nodes (15): TagDiscipline, disciplineMatch(), DisciplineTag, getDisciplineTags(), getDisciplineTagsImpl(), getPublicMediaTag(), MediaMode, PublicMediaTag (+7 more)

### Community 59 - "editor-state.ts"
Cohesion: 0.23
Nodes (7): appearanceLocation(), MediaAppearancesSection(), splitLocationLabel(), appearanceError(), findFirstAppearanceError(), MEDIA_CATEGORIES, appearance()
...
Cohesion: 0.16
Nodes (16): currencies, MediaPeoplePicker(), SelectedPerson, useMediaEditorState(), CryptoCurrency, MediaCategory, MediaItem, MediaType (+8 more)

### Community 62 - "MediaWizard.tsx"
Cohesion: 0.22
Nodes (8): MediaDetailsSection(), BusyAction, Editor, MediaWizard(), STEPS, MediaWizardPreview(), Uploaded, getCloudinaryMediaFolderForCategory()

### Community 63 - "route.ts"
Cohesion: 0.25
Nodes (16): PATCH(), asDate(), POST(), asFiniteNumber(), isRecord(), PATCH(), revalidateTagSurfaces(), GET() (+8 more)
...
Cohesion: 0.44
Nodes (7): asBooleanOrNull(), POST(), ensureUniqueSlug(), POST(), slugify(), hashPassword(), makeAccessToken()
...
Cohesion: 0.13
Nodes (34): POST(), CLOUDINARY_MANAGED_FOLDERS, CloudinaryAssetRef, CloudinaryCleanupResult, cloudinaryErrorMessage(), CloudinaryResourceType, deleteFolderViaAdminApi(), deleteManagedCloudinaryFolderTree() (+26 more)
...
## Knowledge Gaps
- **749 isolated node(s):** `DISCIPLINE_HREFS`, `Category`, `EMPTY`, `ERROR_MESSAGES`, `CATEGORY_ICONS` (+744 more)
...
- **Why does `getDb()` connect `isRecord()` to `admin.ts`, `getDb()`, `route.ts`, `route.ts`, `getPageSections()`, `testimonial-upload-sessions.ts`, `AdminServicesClient.tsx`, `page-sections.ts`, `testimonials.ts`, `page.tsx`, `BlogPostEditor.tsx`, `page.tsx`, `cn()`, `page.tsx`, `page-settings.ts`, `PeopleAdminClient.tsx`, `NftModal.tsx`, `route.ts`, `AdminTagsClient.tsx`, `public-people.ts`, `db.ts`, `HomeExhibitionGlobe.tsx`, `WorkOverlay.tsx`, `route.ts`, `route.ts`, `removal-requests.ts`?**
...
- **Should `getPageSections()` be split into smaller, more focused modules?**
